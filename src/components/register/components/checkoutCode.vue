    ...
    export default {
        ...
        methods: {
            ...
            successFunction(){
                ...
                this.$emit('checkoutFun',!this.confirmSuccess);
                if(window.addEventListener){
                    document.getElementsByClassName('handler')[0].removeEventListener('touchmove',this.mouseMoveFn);
                    document.getElementsByClassName('handler')[0].removeEventListener('touchend',this.moseUpFn);
                }else {
                    document.getElementsByClassName('handler')[0].removeEventListener('touchend',()=>{});
                }
        ...
        mounted(){
            ...
            document.getElementsByClassName('handler')[0].addEventListener('touchmove',this.mouseMoveFn);
